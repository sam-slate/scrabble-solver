...
if __name__ == "__main__":
	game = scrabble_solver_game.Game(SCRABBLE_HEIGHT, SCRABBLE_WIDTH, placed_tiles_1, SCRABBLE_BONUS_PLACEMENTS, SCRABBLE_LETTER_POINTS, current_rack_1, SCRABBLE_BINGO_BONUS, DICTIONARY)
	game.Algorithm()
